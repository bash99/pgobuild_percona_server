...
[[ "$MYSQL_VER" == "8.0" ]] && export PROFILE_FLAG="-DFPROFILE_GENERATE=1"
...
## 8.0 has cmake options to enable pgo
[[ "$MYSQL_VER" == "8.0" ]] && export optflags=" $CPU_OPT_FLAGS -Wno-missing-profile"
[[ "$MYSQL_VER" == "8.0" ]] && export PROFILE_FLAG="-DFPROFILE_USE=1 -DFPROFILE_GENERATE=0 -DWITH_LTO=1"
