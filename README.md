...
you 'll found a benchmark result file like 8.0_pgo_result.txt in current dir, and two minified package(remove mysql-test and striped debug-symbols) like mini_percona-server-8.0.19-10-pgo-linux-x86_64.tar.xz and mini_percona-server-8.0.19-10-linux-x86_64.tar.xz
