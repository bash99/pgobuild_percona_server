...
## we need set plugin-dir for init part
MYSQLD_WITHOPT="$MYSQLD_PATH --defaults-file=$MYSQL_CNF_PATH --basedir=$MYSQL_BASE --datadir=${MYSQL_DATA_PATH} --plugin-dir=$MYSQL_BASE/lib/plugin --user=$MYSQL_USER"
